...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`SALES ANALYTICS - AGENT PERFORMANCE REVIEW`}</title>

        <meta
          name="description"
          content="Discover SALES ANALYTICS - AGENT PERFORMANCE REVIEW: Your key to explore sales dynamics, track agent performance, scrutinize policies sold, and forecast trends. An AI-powered, elegant, and insightful solution tailored to your agency."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1556155092-490a1ba16284?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzYWxlcyUyMGFuYWx5dGljc3xlbnwwfHx8fDE2OTY2MjgyNTZ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`SALES ANALYTICS - AGENT PERFORMANCE REVIEW`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Discover SALES ANALYTICS - AGENT PERFORMANCE REVIEW: Your key to explore sales dynamics, track agent performance, scrutinize policies sold, and forecast trends. An AI-powered, elegant, and insightful solution tailored to your agency.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Data Analyst" type="data-analyst" abilities={appConfig.ownerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
